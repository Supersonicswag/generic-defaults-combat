...
self.Entity:SetColor(255,255,0,255)
 ...
 function ENT:Think()
	...
	self.flightvector = self.flightvector - self.flightvector/35 + self.Entity:GetUp()*2 + Vector(math.Rand(-0.15,0.15), math.Rand(-0.15,0.15),math.Rand(-0.15,0.15)) + Vector(0,0,-0.3)
