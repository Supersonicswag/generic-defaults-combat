...
if ( CLIENT ) then
	...
	language.Add( "Tool_gdcweapons_help0", ".30 caliber medium machine gun. Effective against infantry." )
	language.Add( "Tool_gdcweapons_help1", ".50 caliber heavy machine gun. Effective against light vehicles, infantry, and light aircraft." )
	language.Add( "Tool_gdcweapons_help2", "20mm gatling gun. Effective against light vehicles and infantry." )
	language.Add( "Tool_gdcweapons_help3", "25mm cannon. Effective against medium vehicles, infantry, and aircraft." )
	language.Add( "Tool_gdcweapons_help4", "30mm chain gun. Effective against infantry and light vehicles." )
	language.Add( "Tool_gdcweapons_help5", "30mm cannon. Effective against medium vehicles, infantry, and aircraft." )
	language.Add( "Tool_gdcweapons_help6", "40mm cannon. Effective against medium vehicles and infantry. " )
	...
	language.Add( "Tool_gdcweapons_help16", "81mm rocket assisted mortar launcher." )
