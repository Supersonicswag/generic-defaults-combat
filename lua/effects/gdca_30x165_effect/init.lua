 	...
 	local emitter = ParticleEmitter( vOffset ) 
 		...
 		for i=0, NumParticles do 
 			...
 			if (particle) then 
 				...
 				particle:SetVelocity( VectorRand() * math.Rand(1000, 1500) ) 
			...
			local particle1 = emitter:Add( "particles/flamelet"..math.Rand(1,5), vOffset ) 
 			if (particle1) then 
 				...
 				particle1:SetStartSize( math.Rand(20, 30) ) 
 				particle1:SetEndSize( math.Rand(40, 60) ) 
			...
			local particle2 = emitter:Add( "particles/smokey", vOffset ) 
 			if (particle2) then 
 				...
 				particle2:SetVelocity( data:GetNormal() + Vector(math.Rand(-1,1),math.Rand(-1,1),math.Rand(-1,1)) * math.Rand(1000, 1500) ) 
 				 
 				particle2:SetLifeTime( 0 ) 
 				particle2:SetDieTime( math.Rand(0.2, 1.2) ) 
 				 
 				particle2:SetStartAlpha( 255 ) 
 				particle2:SetEndAlpha( 0 ) 
 				 
 				particle2:SetStartSize( math.Rand(50, 70) ) 
 				particle2:SetEndSize( math.Rand(80, 100) ) 
