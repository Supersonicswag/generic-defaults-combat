...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create ("gdcwa_10x22_350")
	ent:SetPos (SpawnPos)
	ent:Spawn()
	ent:Activate()
	return ent
...
function ENT:Think()
	...
	local tr = util.TraceLine( trace )
				...
				local dmginfo = DamageInfo()
					dmginfo:SetDamage( math.Rand(70,105) ) 	--1 or 2 hits for a kill
					...
					dmginfo:SetDamageForce( self.flightvector/25 ) 	--A few newtons...
