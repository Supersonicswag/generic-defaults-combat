...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create ("gdcwa_7.62x51_ap")
	ent:SetPos (SpawnPos)
	ent:Spawn()
	ent:Activate()
	return ent
...
function ENT:Think()
	...
	self.flightvector = self.flightvector - self.flightvector/150 + Vector(math.Rand(-0.03,0.03), math.Rand(-0.03,0.03),math.Rand(-0.03,0.03)) + Vector(0,0,-0.06)
