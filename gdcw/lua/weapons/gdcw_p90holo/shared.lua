...
SWEP.ViewModel				= "models/weapons/v_P90HOLO.mdl"
...
SWEP.IronSightsPos = Vector (3.8436, -1.9252, 0.4575)
SWEP.IronSightsAng = Vector (0, 0, 0)
SWEP.SightsPos = Vector (3.8436, -1.9252, 0.4575)
