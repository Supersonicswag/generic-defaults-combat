...
SWEP.Instructions				= "15 meter casualty radius. Left click to throw, hold right click to toss."
...
SWEP.ViewModel 				= "models/weapons/v_GDC_FragGrenade.mdl"
SWEP.WorldModel 			= "models/weapons/w_GDC_FragGrenade.mdl"

SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Round 			= ("gdcwa_fragnade")	
