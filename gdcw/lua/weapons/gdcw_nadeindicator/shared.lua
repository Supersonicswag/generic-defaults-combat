...
SWEP.Instructions				= "Red smoke indicator grenade. Left click to throw, hold right click to toss."
...
SWEP.ViewModel 				= "models/weapons/v_GDCW_INDICATOR.mdl"
SWEP.WorldModel 			= "models/weapons/w_eq_flashbang.mdl"

SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Round 			= ("gdcwa_indicatornade")	
