...
SWEP.Instructions				= "Smoke grenade, 10 second dispersal. Left click to throw, hold right click to toss."
...
SWEP.ViewModel 				= "models/weapons/v_GD_SMOKENADE.mdl"
SWEP.WorldModel 			= "models/weapons/w_eq_smokegrenade.mdl"

SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Round 			= ("gdcwa_smokenade")	
