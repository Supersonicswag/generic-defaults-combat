...
SWEP.ViewModel				= "models/weapons/v_GDCAKIRO.mdl"
...
SWEP.IronSightsPos = Vector (4.5347, -4.2492, 1.843)
SWEP.IronSightsAng = Vector (0.6247, -0.0475, 0)
SWEP.SightsPos = Vector (4.5347, -4.2492, 1.843)
SWEP.SightsAng = Vector (0.6247, -0.0475, 0)
