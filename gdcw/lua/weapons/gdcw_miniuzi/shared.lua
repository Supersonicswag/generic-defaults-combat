...
SWEP.ViewModel				= "models/weapons/v_GDCWMIUZI.mdl"
SWEP.WorldModel				= "models/weapons/w_GDCMINIUZI.mdl"
...
SWEP.IronSightsPos = Vector (-2.373, -1.4042, 0.5166)
SWEP.IronSightsAng = Vector (0, 0, 0)
SWEP.SightsPos = Vector (-2.373, -1.4042, 0.5166)
