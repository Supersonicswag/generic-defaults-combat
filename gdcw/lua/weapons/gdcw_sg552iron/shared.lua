...
SWEP.ViewModel				= "models/weapons/v_GDCW_SG552IRO.mdl"
...
SWEP.IronSightsPos = Vector (2.9365, 0, 0.3323)
SWEP.IronSightsAng = Vector (1.0547, 0.0619, 0)
SWEP.SightsPos = Vector (2.9365, 0, 0.3323)
SWEP.SightsAng = Vector (1.0547, 0.0619, 0)
