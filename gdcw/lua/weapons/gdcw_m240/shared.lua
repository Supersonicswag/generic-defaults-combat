...
SWEP.ViewModel				= "models/weapons/v_GDCW_M240PARA.mdl"
SWEP.WorldModel				= "models/weapons/w_GDCM240.mdl"
SWEP.Base 				= "gdcw_base_assault"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true

SWEP.Primary.Sound			= Sound("M240F.single")
SWEP.Primary.Round			= ("gdcwa_7.62x51_900")
...
SWEP.IronSightsPos = Vector (-3.7387, 0, 1.5298)
SWEP.IronSightsAng = Vector (0.1639, -0.021, 0)
SWEP.SightsPos = Vector (-3.7387, 0, 1.5298)
SWEP.SightsAng = Vector (0.1639, -0.021, 0)
