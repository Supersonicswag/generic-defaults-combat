...
SWEP.ViewModel				= "models/weapons/v_GDC_SG552.mdl"
...
SWEP.IronSightsPos = Vector (3.2388, -0.5275, 0.5748)
SWEP.IronSightsAng = Vector (1.2992, 0.0557, 0)
SWEP.SightsPos = Vector (3.2388, -0.5275, 0.5748)
SWEP.SightsAng = Vector (1.2992, 0.0557, 0)
