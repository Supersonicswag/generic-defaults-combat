...
local sounds={
	[1]={
		"WAC/tank/tank_shell_metal_01.wav",
		"WAC/tank/tank_shell_metal_02.wav",
		"WAC/tank/tank_shell_metal_03.wav",
		"WAC/tank/tank_shell_metal_04.wav",
	},
	[2]={
		"WAC/tank/tank_shell_01.wav",
		"WAC/tank/tank_shell_02.wav",
		"WAC/tank/tank_shell_03.wav",
		"WAC/tank/tank_shell_04.wav",
		"WAC/tank/tank_shell_05.wav",
	},
}
...
function EFFECT:Init(data)
	...
	self.Mat=(self.Mat!=0)and(self.Mat)or(MAT_DIRT)
