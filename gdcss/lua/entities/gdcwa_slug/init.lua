...
self.Flightvector 	= self.Entity:GetUp()*((360*39.37)/66)	// Velocity in m/s, FIRST NUMMER is SPEED (FrameTime)
...
self.BallisticDrag	= 170					// Fraction of velocity lost per tick, higher is less
