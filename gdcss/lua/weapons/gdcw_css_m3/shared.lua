...
--------------------
SWEP.IronSightsPos = Vector (5.7325, 0, 3.2585)
SWEP.IronSightsAng = Vector (0.3269, 0.0627, 0)
SWEP.SightsPos = Vector (5.7325, 0, 3.2585)
SWEP.SightsAng = Vector (0.3269, 0.0627, 0)
